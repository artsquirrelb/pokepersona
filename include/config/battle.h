...
#define B_MOVE_DESCRIPTION_BUTTON   SELECT_BUTTON // If set to a button other than B_LAST_USED_BALL_BUTTON, pressing this button will open the move description menu
