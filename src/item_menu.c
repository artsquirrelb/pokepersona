...
static const u8 sText_BlueText[] = _("{COLOR 5}{STR_VAR_2}");
...
static const u8 sFontColorTable[][3] = {
    ...
    */
    [COLORID_NORMAL]      = {TEXT_COLOR_TRANSPARENT, 2,      0},
    [COLORID_POCKET_NAME] = {TEXT_COLOR_TRANSPARENT, 2,      0},
    [COLORID_GRAY_CURSOR] = {TEXT_COLOR_TRANSPARENT, 2,      TEXT_COLOR_DARK_GRAY},
    [COLORID_UNUSED]      = {TEXT_COLOR_DARK_GRAY,   2,      TEXT_COLOR_DARK_GRAY},
...
static void PrintItemQuantity(u8 windowId, s16 quantity)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_xVar1);
    AddTextPrinterParameterizedCustom(windowId, FONT_NORMAL, gStringVar4, GetStringCenterAlignXOffset(FONT_NORMAL, gStringVar4, 0x28), 2, 0, 0, 1, 3, 3);
}
...
static void PrintItemSoldAmount(int windowId, int numSold, int moneyEarned)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_xVar1);
    AddTextPrinterParameterizedCustom(windowId, FONT_NORMAL, gStringVar4, 0, 1, TEXT_SKIP_DRAW, 0, 1, 3, 3);
