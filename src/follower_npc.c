...
static bool32 IsStateMovement(u32 state)
{
    ...
    case MOVEMENT_ACTION_EMOTE_CRY:
    case MOVEMENT_ACTION_EMOTE_SWEAT:
    case MOVEMENT_ACTION_EMOTE_ASLEEP:
    case MOVEMENT_ACTION_POINT_UP_1:
    case MOVEMENT_ACTION_POINT_UP_2:
    case MOVEMENT_ACTION_POINT_UP_3:
