...
static const struct Mugshot sMugshots[] = {
    ...
    [PIC_AKIHIKO] = {.x = 18, .y = 5, .width = 64, .height = 64, .image = sMugshotImg_Akihiko, .palette = sMugshotPal_Akihiko},
    [PIC_SHINJIRO] = {.x = 18, .y = 5, .width = 64, .height = 64, .image = sMugshotImg_Shinjiro, .palette = sMugshotPal_Shinjiro},
};
