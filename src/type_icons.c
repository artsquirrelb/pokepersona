...
static void CreateSpriteAndSetTypeSpriteAttributes(enum Type type, u32 x, u32 y, u32 position, enum BattlerId battler, bool32 useDoubleBattleCoords)
{
    ...
    if (gTypesInfo[type].useSecondTypeIconPalette == TRUE)
        spriteTemplate = &sSpriteTemplate_TypeIcons2;
    else if (gTypesInfo[type].useThirdTypeIconPalette == TRUE)
        spriteTemplate = &sSpriteTemplate_TypeIcons3;
    else
        spriteTemplate = &sSpriteTemplate_TypeIcons1;
