...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_WINSTON] = REMATCH(TRAINER_TAROU, TRAINER_WINSTON_2, TRAINER_WINSTON_3, TRAINER_WINSTON_4, TRAINER_WINSTON_5, MAP_ROUTE104),
    ...
    //[REMATCH_GABRIELLE] = REMATCH(TRAINER_IKE_2, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MAP_MT_PYRE_3F),
    ...
    //[REMATCH_SAWYER] = REMATCH(TRAINER_IKE, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MAP_MT_CHIMNEY),
...
enum BattleEnvironments BattleSetup_GetEnvironmentId(void)
{
    ...
    if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_WINDWARD_PORT_BEACH) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(MAP_WINDWARD_PORT_BEACH))
        return BATTLE_ENVIRONMENT_SAND;
...
static void CB2_GiveStarter(void)
{
    ...
    *GetVarPointer(VAR_ROD_TYPE) = gSpecialVar_Result;
