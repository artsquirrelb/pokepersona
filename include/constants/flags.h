...
#define FLAG_UNUSED_0x69                     0x69 //renamed to unused (not actually unused)
...
#define FLAG_HIDE_KUROSAWA                   0x71 // Was unused Flag. Used in R/S to indicate whether player defeated or caught Groudon/Kyogre in Cave of Origin.
...
#define FLAG_HIDE_SHINJIRO                   0xC2 // Leftover from the RS version of Puzzle Room 7, functionally unused
...
#define FLAG_SUNSHINETOWN_TM_THIEF               0x10D
...
#define FLAG_HIDDEN_ITEM_CORALPORT_PEARL                     (FLAG_HIDDEN_ITEMS_START + 0x0A)
...
#define FLAG_HIDDEN_ITEM_ROUTE_2_GREAT_BALL                (FLAG_HIDDEN_ITEMS_START + 0x33) //Route 2
...
#define FLAG_HIDDEN_ITEM_SUNSHINE_ORPHANAGE_ANTIDOTE                  (FLAG_HIDDEN_ITEMS_START + 0x55) //kurosawas house
...
// Event Flags
#define FLAG_LOCK_MITSURU                                           0x2BC
#define FLAG_LOCK_AKIHIKO                                           0x2BD
#define FLAG_LOCK_SHINJIRO                                          0x2BE
#define FLAG_LOCK_INTELEON_T                                        0x2BF
...
#define FLAG_HIDE_MIKI                                              0x339 // Was Unused, leftover from R/S
...
// Item Ball Flags
#define FLAG_ITEM_ROUTE_1_ALTARIANITE                               0x3E8
#define FLAG_ITEM_ROUTE_1_TM_THUNDER_PUNCH                          0x3E9
...
#define FLAG_ITEM_WINDWARD_PORT_HOUSE_GREAT_BALL                    0x3F7
#define FLAG_ITEM_WINDWARD_BEACH_MIRACLE_SEED                       0x3F8
#define FLAG_ITEM_SUNSHINE_ORPHANAGE_HALL_CHEST                     0x3F9
#define FLAG_ITEM_ROUTE_2_FRIENDBALL                                0x3FA
#define FLAG_ITEM_SUNSHINE_WOODS_REPEL                              0x3FB
#define FLAG_ITEM_MANSION_GARDEN_PRETTYWINGS                        0x3FC
#define FLAG_HIDDENGROTTO_ROUTE1_CHEST                              0x3FD
#define FLAG_ITEM_SUNSHINE_MEADOW_LOVEBALL                          0x3FE
#define FLAG_ITEM_CORALPORT_LUREBALL                                0x3FF
#define FLAG_ITEM_CORALPORT_TM_CHILLING_WATER                       0x400
#define FLAG_ITEM_MAYOIDOLAB_CHEST                                  0x401
#define FLAG_ITEM_WINDWARDPORT_MUSCLEFEATHERS                        0x402
...
#define FLAG_SYS_QUEST_MENU_GET                      (SYSTEM_FLAGS + 0x3) // add QUESTS to start menu// was Unused Flag
...
#define FLAG_VISITED_KIBOU_CITY                     (SYSTEM_FLAGS + 0x12)
#define FLAG_VISITED_TENERE_TOWN                    (SYSTEM_FLAGS + 0x13)
#define FLAG_VISITED_PAULOWNIA_CITY                 (SYSTEM_FLAGS + 0x14)
#define FLAG_VISITED_AKIKAZE_CITY                (SYSTEM_FLAGS + 0x15)
#define FLAG_VISITED_NATA_CITY                 (SYSTEM_FLAGS + 0x16)
#define FLAG_VISITED_MIHARU_TOWN                 (SYSTEM_FLAGS + 0x17)
#define FLAG_VISITED_KAZAHANA_CITY                  (SYSTEM_FLAGS + 0x18)
#define FLAG_VISITED_SILVERFROST_VILLAGE                  (SYSTEM_FLAGS + 0x19)
#define FLAG_VISITED_FAERUMA_CITY                   (SYSTEM_FLAGS + 0x1A)
#define FLAG_VISITED_FUNSEKI_TOWN                  (SYSTEM_FLAGS + 0x1B)
#define FLAG_VISITED_KYOUI_CITY                  (SYSTEM_FLAGS + 0x1C)
...
#define FLAG_DAILY_HIDDENGROTTO_ROUTE1              (DAILY_FLAGS_START + 0x0)  // Was Unused Flag
...
#define FLAG_DAILY_ROUTE_111_RECEIVED_BERRY         (DAILY_FLAGS_START + 0xC) //sunshine town house 1
...
#define FLAG_DAILY_MINING_ROCK_THUNDERSHARDS_CAVE_1F      (DAILY_FLAGS_START + 0x15) // Was Unused Flag
#define FLAG_DAILY_MINING_ROCK2_THUNDERSHARDS_CAVE_1F     (DAILY_FLAGS_START + 0x16) // Was Unused Flag
