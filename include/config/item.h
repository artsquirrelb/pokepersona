...
#define I_EXP_SHARE_FLAG        EXP_SHARE_FLAG           // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
