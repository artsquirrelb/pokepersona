...
#define OUTFIT_MITSURU 1
#define OUTFIT_AKIHIKO 2
#define OUTFIT_SHINJIRO 3
#define OUTFIT_COUNT 4

// inclusive
#define OUTFIT_BEGIN OUTFIT_MITSURU
#define OUTFIT_END   OUTFIT_SHINJIRO

#define DEFAULT_OUTFIT OUTFIT_MITSURU
