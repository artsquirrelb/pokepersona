...
#define VAR_ROD_TYPE                                     0x4023 // 0=Treecko, 1=Torchic, 2=Mudkip
...
#define VAR_QUEST_FIND_MINING_KIT_STATE                  0x4066 // Unused Var
#define VAR_WINDWARD_HARBOR_GHOST_BOY                    0x4067 // Unused Var
...
enum VarAkiIntro{
    ...
    A_NEGO_W_M,
    A_M_OFFERS_BATTLE,
    A_AS_LEAVING_R2_HOUSE,
    A_TO_SUNSHINE_MEADOW,
    A_M_1ST_BATTLE,
    A_SM_1ST_BATTLE,
    A_M_EXPLAINS_OBJECTIVES,
    A_CANT_SLEEP,
    A_S_1ST_BATTLE,
    A_1ST_MORNING,
    A_SHOW_MAP,
    A_NOT_PLAYER = 50,
    A_INTRO_COMPLETED = 100,
    A_INTRO_GAMEOVER = 255,
};
...
enum VarMitsuIntro{
    ...
    M_LEAVING_MANSION,
    M_TOO_LATE_NIGHT,
    M_REST_FOR_THE_NIGHT,
    M_TO_THUNDERSHARD,
    M_KG_STAFF_DOUBLE,
    M_MUST_FIGHT_KG_STAFF,
    M_VS_NORBERT,
    M_EXPLOSION,
    M_TO_SUNSHINE_TOWN,
    M_HEARD_ORPHANAGE_EXPLOSION,
    M_KG_STAFF_WOODS_ENTRANCE,
    M_FOLLOW_KG_STAFF,
    M_IN_SUNSHINE_WOODS,
    M_AMBUSH_IN_SSWOODS,
    M_ASK_AROUND_FOR_AKSJ,
    M_ASKING_FATMAN,
    M_APPROACH_KRSW_HOUSE,
    M_CALLING_TKHR,
    M_TO_ROUTE_2,
    M_SAVED_AKSJ,
    M_TO_SUNSHINE_MEADOW,
    M_A_1ST_BATTLE,
    M_EXPLAIN_OBJECTIVE,
    M_1ST_MORNING,
    M_SHOW_MAP,
    M_NOT_PLAYER = 50,
    M_INTRO_COMPLETED = 100,
};

enum VarChapter1{
    C1_START,
    C1_TO_POLICE_STATION,
    C1_ASK_ABOUT_MIKI,
    C1_WAITING_SHIP,
    C1_BOARDING_SHIP,
    C1_TO_MAYOIDOS_LAB,
