...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_SHINJIRO,
    TRAINER_PIC_FRONT_INTELEON_T,
    TRAINER_PIC_FRONT_SCIENTIST_1,
    TRAINER_PIC_FRONT_SCIENTIST_2,
    TRAINER_PIC_FRONT_NORBERT,
    TRAINER_PIC_FRONT_DUSCLOPS_HORDE,
    TRAINER_PIC_FRONT_PRESCHOOLER_M,
    TRAINER_PIC_FRONT_PRESCHOOLER_F,
    TRAINER_PIC_FRONT_ROUGHNECK,
    TRAINER_PIC_FRONT_ROUGHNECK_2,
