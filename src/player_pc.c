...
static void ItemStorageMenuPrint(const u8 *textPtr)
{
    ...
    AddTextPrinterParameterizedCustom(0, FONT_NORMAL, textPtr, 0, 1, 0, 0, 2, 0x0, 0x0);
}
...
static void Mailbox_DrawMailboxMenu(u8 taskId)
{
    ...
    AddTextPrinterParameterizedCustom(windowId, FONT_NORMAL, sText_Mailbox, GetStringCenterAlignXOffset(FONT_NORMAL, sText_Mailbox, 0x40), 1, 0, NULL, 1, 0x0, 0x0);
    ScheduleBgCopyTilemapToVram(0);
...
static void ItemStorage_PrintMenuItem(u8 windowId, u32 id, u8 yOffset)
{
    if (id != LIST_CANCEL)
    {
        ...
        AddTextPrinterParameterizedCustom(windowId, FONT_NARROW, gStringVar4, GetStringRightAlignXOffset(FONT_NARROW, gStringVar4, 104), yOffset, TEXT_SKIP_DRAW, NULL, 1, 0x0, 0x0);
    }
}
...
static void ItemStorage_PrintDescription(s32 id)
{
    ...
    AddTextPrinterParameterizedCustom(windowId, FONT_NORMAL, description, 0, 1, 0, NULL, 1, 0x0, 0x0);
}
...
static void ItemStorage_CreateListMenu(u8 taskId)
{
    ...
    AddTextPrinterParameterizedCustom(sItemStorageMenu->windowIds[ITEMPC_WIN_TITLE], FONT_NORMAL, text, x, 1, 0, NULL, 1, 0x0, 0x0);
...
static void ItemStorage_PrintMessage(const u8 *string)
{
    ...
    AddTextPrinterParameterizedCustom(windowId, FONT_NORMAL, gStringVar4, 0, 1, 0, NULL, 1, 0x0, 0x0);
}
...
static void ItemStorage_PrintItemQuantity(u8 windowId, u16 value, u32 mode, u8 x, u8 y, u8 n)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_xVar1);
    AddTextPrinterParameterizedCustom(windowId, FONT_NORMAL, gStringVar4, GetStringCenterAlignXOffset(FONT_NORMAL, gStringVar4, 48), y, 0, NULL, 1, 0x0, 0x0);
}
