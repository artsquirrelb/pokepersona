...
static void Debug_ShowMenu(DebugFunc HandleInput, const struct DebugMenuOption *items)
{
    ...
    menuTemplate.cursorShadowPal = 0;
...
static const u16 sLocationFlags[] =
{
    ...
    FLAG_VISITED_CORALPORT,
    FLAG_VISITED_WINDWARD_PORT,
    FLAG_VISITED_KIBOU_CITY,
    FLAG_VISITED_TENERE_TOWN,
    FLAG_VISITED_PAULOWNIA_CITY,
    FLAG_VISITED_AKIKAZE_CITY,
    FLAG_VISITED_NATA_CITY,
    FLAG_VISITED_MIHARU_TOWN,
    FLAG_VISITED_KAZAHANA_CITY,
    FLAG_VISITED_SILVERFROST_VILLAGE,
    FLAG_VISITED_FAERUMA_CITY,
    FLAG_VISITED_FUNSEKI_TOWN,
    FLAG_VISITED_KYOUI_CITY,
...
static void DebugAction_Util_Warp_Warp(u8 taskId)
{
    ...
    AddTextPrinterParameterizedCustom(windowId, DEBUG_MENU_FONT, gStringVar4, 0, 0, 0, NULL, 1, 3, 3);
...
static void DebugAction_Util_Warp_SelectMapGroup(u8 taskId)
{
    if (JOY_NEW(DPAD_ANY))
    {
        ...
        StringExpandPlaceholders(gStringVar4, sDebugText_Util_WarpToMap_SelectMapGroup);
        AddTextPrinterParameterizedCustom(gTasks[taskId].tSubWindowId, DEBUG_MENU_FONT, gStringVar4, 0, 0, 0, NULL, 1, 3, 3);
    }
...
#define SOUND_LIST_BGM              \
    ...
    X(MUS_XC2_GARFONT_MERCERNARIES) \
    X(MUS_XC2_GARFONT_MERCERNARIES_NIGHT)        \
    X(MUS_XC2_TORIGOTH_NIGHT)       \
    X(MUS_P5_RUN_RUN_RUN)           \
    X(MUS_P5_MENTAL_BREAKDOWN)      \
    X(MUS_P3_CALAMITY)              \
    X(MUS_P3R_FEARFUL_EXPERIENCE)   \
    X(MUS_P3FES_IWATODAI_DORM)      \
    X(MUS_P3R_ITS_GOING_DOWN_NOW)   \
    X(MUS_P3R_MEMORIES_OF_THE_CITY) \
    X(MUS_P5_BLOOMING_VILLAIN)      \
    X(MUS_XC2_TORNA_BATTLE)         \
    X(MUS_XC2_INCOMING)             \
