...
const u16 gTrainerPalette_BrendanBack[] = INCBIN_U16("graphics/trainers/back_pics/brendan.gbapal");
...
const u16 gTrainerPalette_MayBack[] = INCBIN_U16("graphics/trainers/back_pics/may.gbapal");
...
const u32 gTrainerFrontPic_Roughneck2[] = INCBIN_U32("graphics/trainers/front_pics/roughneck_2.4bpp.smol");
const u16 gTrainerPalette_Roughneck2[] = INCBIN_U16("graphics/trainers/front_pics/roughneck_2.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SHINJIRO, gTrainerFrontPic_Shinjiro, gTrainerPalette_Shinjiro),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_INTELEON_T, gTrainerFrontPic_Inteleon_T, gTrainerPalette_Inteleon_T),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SCIENTIST_1, gTrainerFrontPic_Scientist_1, gTrainerPalette_Scientist_1),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SCIENTIST_2, gTrainerFrontPic_Scientist_2, gTrainerPalette_Scientist_2),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_NORBERT, gTrainerFrontPic_Norbert, gTrainerPalette_Norbert),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_DUSCLOPS_HORDE, gTrainerFrontPic_DusclopsHorde, gTrainerPalette_DusclopsHorde),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_PRESCHOOLER_M, gTrainerFrontPic_PreschoolerM, gTrainerPalette_PreschoolerM),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_PRESCHOOLER_F, gTrainerFrontPic_PreschoolerF, gTrainerPalette_PreschoolerF),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ROUGHNECK, gTrainerFrontPic_Roughneck, gTrainerPalette_Roughneck),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ROUGHNECK_2, gTrainerFrontPic_Roughneck2, gTrainerPalette_Roughneck2),
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_MAY, 4, gTrainerBackPic_May, gTrainerPalette_MayBack, sBackAnims_Hoenn),
    ...
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_INTELEON_T, 4, gTrainerBackPic_Inteleon_T, gTrainerBackPalette_Inteleon_T, sBackAnims_Hoenn),
};
