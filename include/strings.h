...
extern const u8 gText_PkmnFriendlier[];
...
//names
extern const u8 gText_StoryQuests[];
extern const u8 gText_SideQuest1_Name[];
extern const u8 gText_SideQuest2_Name[];
extern const u8 gText_SideQuest3_Name[];
extern const u8 gText_SideQuest4_Name[];
extern const u8 gText_SideQuest5_Name[];
extern const u8 gText_SideQuest6_Name[];
extern const u8 gText_SideQuest7_Name[];
...
//descriptions
extern const u8 gText_StoryQuestsDesc1[];
extern const u8 gText_StoryQuestsDesc2[];
extern const u8 gText_StoryQuestsDesc3[];
extern const u8 gText_StoryQuestsDesc4[];
extern const u8 gText_StoryQuestsDesc5[];
extern const u8 gText_StoryQuestsDesc6[];
extern const u8 gText_StoryQuestsDesc7[];
extern const u8 gText_StoryQuestsDesc8[];
extern const u8 gText_StoryQuestsDesc9[];
extern const u8 gText_StoryQuestsDesc10[];

extern const u8 gText_SideQuest1_Desc[];
extern const u8 gText_SideQuest2_Desc[];

extern const u8 gText_SideQuest3_Desc0[];
extern const u8 gText_SideQuest3_Desc1[];
extern const u8 gText_SideQuest3_Desc2[];
extern const u8 gText_SideQuest3_Desc3[];
extern const u8 gText_SideQuest3_Desc4[];
extern const u8 gText_SideQuest3_Desc5[];
extern const u8 gText_SideQuest3_Desc6[];
extern const u8 gText_SideQuest3_Desc7[];
extern const u8 gText_SideQuest3_Desc8[];
extern const u8 gText_SideQuest3_Desc9[];
extern const u8 gText_SideQuest3_Desc10[];
extern const u8 gText_SideQuest3_Desc11[];
extern const u8 gText_SideQuest3_Desc12[];
extern const u8 gText_SideQuest3_Desc13[];
extern const u8 gText_SideQuest3_Desc14[];
extern const u8 gText_SideQuest3_Desc15[];
extern const u8 gText_SideQuest3_Desc16[];
extern const u8 gText_SideQuest3_Desc17[];
extern const u8 gText_SideQuest3_Desc18[];
extern const u8 gText_SideQuest3_Desc19[];
extern const u8 gText_SideQuest3_Desc20[];
extern const u8 gText_SideQuest3_Desc21[];
extern const u8 gText_SideQuest3_Desc22[];
extern const u8 gText_SideQuest3_Desc23[];
extern const u8 gText_SideQuest3_Desc24[];
extern const u8 gText_SideQuest3_Desc25[];
extern const u8 gText_SideQuest3_Desc26[];
extern const u8 gText_SideQuest3_Desc27[];
extern const u8 gText_SideQuest3_Desc28[];
extern const u8 gText_SideQuest3_Desc29[];
extern const u8 gText_SideQuest3_Desc30[];

extern const u8 gText_SideQuest4_Desc[];
extern const u8 gText_SideQuest5_Desc[];
extern const u8 gText_SideQuest6_Desc[];
extern const u8 gText_SideQuest7_Desc[];
...
extern const u8 gText_StoryQuestsDone[];
extern const u8 gText_SideQuest1_DoneDesc[];
extern const u8 gText_SideQuest2_DoneDesc[];
extern const u8 gText_SideQuest3_DoneDesc[];
extern const u8 gText_SideQuest4_DoneDesc[];
extern const u8 gText_SideQuest5_DoneDesc[];
extern const u8 gText_SideQuest6_DoneDesc[];
extern const u8 gText_SideQuest7_DoneDesc[];
...
//map
extern const u8 gText_Sunshine_Town_Map[];
extern const u8 gText_Coralport_Map[];
extern const u8 gText_Chapter1_Map[];
extern const u8 gText_Chapter2_Map[];
extern const u8 gText_Chapter3_Map[];
extern const u8 gText_Chapter4_Map[];
extern const u8 gText_Chapter5_Map[];
extern const u8 gText_Chapter6_Map[];
extern const u8 gText_Chapter7_Map[];
extern const u8 gText_Chapter8_Map[];
extern const u8 gText_WindwardPort_Map[];
...
//subquests
extern const u8 gText_MitsurusPrologue_Name[];
extern const u8 gText_AkihikosPrologue_Name[];
extern const u8 gText_Chapter1_Name[];
extern const u8 gText_Chapter2_Name[];
extern const u8 gText_Chapter3_Name[];
extern const u8 gText_Chapter4_Name[];
extern const u8 gText_Chapter5_Name[];
extern const u8 gText_Chapter6_Name[];
extern const u8 gText_Chapter7_Name[];
extern const u8 gText_Chapter8_Name[];

extern const u8 gText_GhostBoySub_Name1[];
extern const u8 gText_GhostBoySub_Name2[];
extern const u8 gText_GhostBoySub_Name3[];
extern const u8 gText_GhostBoySub_Name4[];
extern const u8 gText_GhostBoySub_Name5[];
extern const u8 gText_GhostBoySub_Name6[];
extern const u8 gText_GhostBoySub_Name7[];
extern const u8 gText_FindStartersSub_Name1[];
extern const u8 gText_FindStartersSub_Name2[];
extern const u8 gText_FindStartersSub_Name3[];
extern const u8 gText_FindStartersSub_Name4[];
extern const u8 gText_FindStartersSub_Name5[];
extern const u8 gText_FindStartersSub_Name6[];
extern const u8 gText_FindStartersSub_Name7[];
extern const u8 gText_FindStartersSub_Name8[];
extern const u8 gText_FindStartersSub_Name9[];
extern const u8 gText_FindStartersSub_Name10[];
extern const u8 gText_FindStartersSub_Name11[];
extern const u8 gText_FindStartersSub_Name12[];
extern const u8 gText_FindStartersSub_Name13[];
extern const u8 gText_FindStartersSub_Name14[];
extern const u8 gText_FindStartersSub_Name15[];
extern const u8 gText_FindStartersSub_Name16[];
extern const u8 gText_FindStartersSub_Name17[];
extern const u8 gText_FindStartersSub_Name18[];
extern const u8 gText_FindStartersSub_Name19[];
extern const u8 gText_FindStartersSub_Name20[];
extern const u8 gText_FindStartersSub_Name21[];
extern const u8 gText_FindStartersSub_Name22[];
extern const u8 gText_FindStartersSub_Name23[];
extern const u8 gText_FindStartersSub_Name24[];

extern const u8 gText_MitsurusPrologue_Desc[];
extern const u8 gText_AkihikosPrologue_Desc[];
extern const u8 gText_Chapter1_Desc[];
extern const u8 gText_Chapter2_Desc[];
extern const u8 gText_Chapter3_Desc[];
extern const u8 gText_Chapter4_Desc[];
extern const u8 gText_Chapter5_Desc[];
extern const u8 gText_Chapter6_Desc[];
extern const u8 gText_Chapter7_Desc[];
extern const u8 gText_Chapter8_Desc[];

extern const u8 gText_GhostBoySub_Desc1[];
extern const u8 gText_GhostBoySub_Desc2[];
...
extern const u8 gText_MitsurusPrologue_Map[];
extern const u8 gText_AkihikosPrologue_Map[];

//////////////////////////////////////////////
/////////////BEGIN COMPLEXE QUEST STRING EXTERNS/////////////
