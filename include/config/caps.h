...
// EV Cap Configs
#define B_EV_CAP_TYPE                   EV_CAP_VARIABLE   // [EV_CAP_NONE, EV_CAP_FLAG_LIST, EV_CAP_VARIABLE, EV_CAP_NO_GAIN] choose the type of EV cap to apply
#define B_EV_CAP_VARIABLE               VAR_CURRENT_EV_CAP // event variable used to derive EV cap if B_EV_CAP_TYPE is set to EV_CAP_VARIABLE
