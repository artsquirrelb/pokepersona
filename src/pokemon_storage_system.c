...
static void PrintMessage(u8 id)
{
    ...
    AddTextPrinterParameterizedCustom(WIN_MESSAGE, FONT_NORMAL, sStorage->messageText, 0, 1, TEXT_SKIP_DRAW, NULL, 1, 0, 0);
...
} static const sRestrictedReleaseMoves[] =
{
    ...
    {MAP_GROUP(MAP_BLANK_MAP), MAP_NUM(MAP_BLANK_MAP), MOVE_STRENGTH},
    {MAP_GROUP(MAP_BLANK_MAP), MAP_NUM(MAP_BLANK_MAP), MOVE_ROCK_SMASH},
    {MAP_GROUP(MAP_BLANK_MAP), MAP_NUM(MAP_BLANK_MAP), MOVE_STRENGTH},
    {MAP_GROUP(MAP_BLANK_MAP), MAP_NUM(MAP_BLANK_MAP), MOVE_ROCK_SMASH},
};
...
bool8 CheckStorageForMonBuffNickBoxId(u16 speciesId)//custom
{
    s32 i, j;
