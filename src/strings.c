...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("Akihiko");
const u8 gText_ExpandedPlaceholder_May[] = _("Mitsuru");
...
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for Pokémon based\non selected parameters.");
...
const u8 gText_SelectPokedexListingMode[] = _("Select the Pokédex\nlisting mode.");
const u8 gText_ListByFirstLetter[] = _("List by the first letter in\nthe name.\nSeen Pokémon only.");
...
const u8 gText_DexHoennTitle[] = _("Kitoha Dex");
...
const u8 gText_DexHoennDescription[] = _("Kitoha region's Pokédex");
const u8 gText_DexNatDescription[] = _("National edition Pokédex");
const u8 gText_DexSortNumericalDescription[] = _("Pokémon are listed\naccording to their number.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned Pokémon\nare listed alphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned Pokémon are listed\nfrom the heaviest to\nthe lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned Pokémon are listed\nfrom the lightest to\nthe heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned Pokémon are listed\nfrom the tallest to\nthe smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned Pokémon are listed\nfrom the smallest to\nthe tallest.");
...
const u8 gText_SelectorArrow[] = _("{COLOR 7}▶");//for pokedex search paramater list only
...
const u8 gText_SelectorArrow2[] = _("{COLOR 4}▶");
...
const u8 gText_DadsAdvice[] = _("You can't use this item now!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnFriendlier[] =_("{STR_VAR_1} turned friendlier toward you!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Battle_Items[] = _("B. ITEMS");
...
const u8 gText_HealthboxNickname[] = _("{BACKGROUND 0}{ACCENT 0}");
...
const u8 gText_StartMenuPal[] = _("MENU PALETTE");
const u8 gText_StartMenuPal1[] = _("1");
const u8 gText_StartMenuPal2[] = _("2");
const u8 gText_StartMenuPal3[] = _("3");
const u8 gText_StartMenuPal4[] = _("4");
...
const u8 gText_OverworldSpeed[] = _("OVERWORLD SPD");
...
const u8 gText_DexHoenn[] = _("Kitoha");
...
const u8 gText_SavingBadges[] = _("Level Cap");
...
const u8 gText_SideQuest4_Name[] = _("Buy A Smile Candy For Misa");
const u8 gText_SideQuest5_Name[] = _("Retrieve Nebe's Prized Collection");
const u8 gText_SideQuest6_Name[] = _("Yamaki's Play Time");
const u8 gText_SideQuest7_Name[] = _("Ran-away Starter Pokémon");
...
const u8 gText_StoryQuestsDesc6[] = _("Currently: Chapter 4");
const u8 gText_StoryQuestsDesc7[] = _("Currently: Chapter 5");
const u8 gText_StoryQuestsDesc8[] = _("Currently: Chapter 6");
const u8 gText_StoryQuestsDesc9[] = _("Currently: Chapter 7");
...
const u8 gText_SideQuest2_Desc[] = _("Follow the Growlithe to find the\nfisherman's daughter!\nReward: Old Rod.");
...
const u8 gText_SideQuest3_Desc11[] = _("Work part-time at AmeAme.\n11/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc12[] = _("Work part-time at AmeAme.\n12/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc13[] = _("Work part-time at AmeAme.\n13/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc14[] = _("Work part-time at AmeAme.\n14/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc15[] = _("Work part-time at AmeAme.\n15/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc16[] = _("Work part-time at AmeAme.\n16/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc17[] = _("Work part-time at AmeAme.\n17/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc18[] = _("Work part-time at AmeAme.\n18/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc19[] = _("Work part-time at AmeAme.\n19/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc20[] = _("Work part-time at AmeAme.\n20/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc21[] = _("Work part-time at AmeAme.\n21/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc22[] = _("Work part-time at AmeAme.\n22/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc23[] = _("Work part-time at AmeAme.\n23/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc24[] = _("Work part-time at AmeAme.\n24/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc25[] = _("Work part-time at AmeAme.\n25/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc26[] = _("Work part-time at AmeAme.\n26/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc27[] = _("Work part-time at AmeAme.\n27/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc28[] = _("Work part-time at AmeAme.\n28/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc29[] = _("Work part-time at AmeAme.\n29/30 times worked.\nReward: Candy Jar.");
const u8 gText_SideQuest3_Desc30[] = _("Work part-time at AmeAme.\n30/30 times worked.\nReward: Candy Jar.");

const u8 gText_SideQuest4_Desc[] = _("Help Misa cheer up her Wooper.\nA Smile Candy will do.\nReward: Good Rod.");

const u8 gText_SideQuest5_Desc[] = _("Thieves've broken into Nebe's\nhouse and stole his tools.\nReward: Mining Kit.");
const u8 gText_SideQuest6_Desc[] = _("The kid only appears at night\nand wants to play Hide-and-Seek.\nReward: ???");
const u8 gText_SideQuest7_Desc[] = _("Bring back the ran-away Pokémon\nfrom Mayoido's Lab.");
...
//map
const u8 gText_Sunshine_Town_Map[] = _("Sunshine Town");
const u8 gText_Coralport_Map[] = _("Coralport");
const u8 gText_WindwardPort_Map[] = _("Windward Port (night)");
...
//subquests
const u8 gText_MitsurusPrologue_Name[] = _("Mitsuru's Prologue");
const u8 gText_AkihikosPrologue_Name[] = _("Akihiko's Prologue");
const u8 gText_Chapter1_Name[] = _("Chapter 1");
const u8 gText_Chapter2_Name[] = _("Chapter 2");
const u8 gText_Chapter3_Name[] = _("Chapter 3");
const u8 gText_Chapter4_Name[] = _("Chapter 4");
const u8 gText_Chapter5_Name[] = _("Chapter 5");
const u8 gText_Chapter6_Name[] = _("Chapter 6");
const u8 gText_Chapter7_Name[] = _("Chapter 7");
const u8 gText_Chapter8_Name[] = _("Chapter 8");

const u8 gText_GhostBoySub_Name1[] = _("Play Hide-and-Seek with Yamaki");
const u8 gText_GhostBoySub_Name2[] = _("Play Treasure Hunt with Yamaki");
const u8 gText_GhostBoySub_Name3[] = _("Play Hide-and-Seek with Yamaki (3)");
const u8 gText_GhostBoySub_Name4[] = _("Play Hide-and-Seek with Yamaki (4)");
const u8 gText_GhostBoySub_Name5[] = _("Play Hide-and-Seek with Yamaki (5)");
const u8 gText_GhostBoySub_Name6[] = _("Play Hide-and-Seek with Yamaki (6)");
const u8 gText_GhostBoySub_Name7[] = _("Play Hide-and-Seek with Yamaki (7)");

const u8 gText_FindStartersSub_Name1[] = _("Finding Bulbasaur");
const u8 gText_FindStartersSub_Name2[] = _("Finding Charmander");
const u8 gText_FindStartersSub_Name3[] = _("Finding Squirtle");
const u8 gText_FindStartersSub_Name4[] = _("Finding Chikorita");
const u8 gText_FindStartersSub_Name5[] = _("Finding Cyndaquil");
const u8 gText_FindStartersSub_Name6[] = _("Finding Totodile");
const u8 gText_FindStartersSub_Name7[] = _("Finding Treecko");
const u8 gText_FindStartersSub_Name8[] = _("Finding Torchic");
const u8 gText_FindStartersSub_Name9[] = _("Finding Mudkip");
const u8 gText_FindStartersSub_Name10[] = _("Finding Turtwig");
const u8 gText_FindStartersSub_Name11[] = _("Finding Chimchar");
const u8 gText_FindStartersSub_Name12[] = _("Finding Piplup");
const u8 gText_FindStartersSub_Name13[] = _("Finding Snivy");
const u8 gText_FindStartersSub_Name14[] = _("Finding Tepig");
const u8 gText_FindStartersSub_Name15[] = _("Finding Chespin");
const u8 gText_FindStartersSub_Name16[] = _("Finding Froakie");
const u8 gText_FindStartersSub_Name17[] = _("Finding Rowlet");
const u8 gText_FindStartersSub_Name18[] = _("Finding Litten");
const u8 gText_FindStartersSub_Name19[] = _("Finding Popplio");
const u8 gText_FindStartersSub_Name20[] = _("Finding Scorbunny");
const u8 gText_FindStartersSub_Name21[] = _("Finding Sobble");
const u8 gText_FindStartersSub_Name22[] = _("Finding Sprigatito");
const u8 gText_FindStartersSub_Name23[] = _("Finding Fuecoo");
const u8 gText_FindStartersSub_Name24[] = _("Finding Quaxly");
...
const u8 gText_Chapter5_Desc[] = _("Description Sub 7");
const u8 gText_Chapter6_Desc[] = _("Description Sub 8");
const u8 gText_Chapter7_Desc[] = _("Description Sub 9");
const u8 gText_Chapter8_Desc[] = _("Description Sub 10");

const u8 gText_GhostBoySub_Desc1[] = _("You found Yamaki quickly enough.\n He vanished into thin air.");
const u8 gText_GhostBoySub_Desc2[] = _("You found the Revive that Yamaki hid.\nReward: Carbos x1.");
...
const u8 gText_Chapter4_Map[] = _("Volcanic Town");
const u8 gText_Chapter5_Map[] = _("Pharmacy Factory");
const u8 gText_Chapter6_Map[] = _("Swarm Island");
const u8 gText_Chapter7_Map[] = _("Kazahana Forest");
const u8 gText_Chapter8_Map[] = _("Underwater Cave");

/////////////////////////////////////////
///////////BEGIN COMPLEXE QUEST STRINGS///////////
...
const u8 gText_FURFROU_HEART[]      = _("Heart");
const u8 gText_FURFROU_STAR[]       = _("Star");
const u8 gText_FURFROU_DIAMOND[]    = _("Diamond");
const u8 gText_FURFROU_DEBUTANTE[]  = _("Debutante");
const u8 gText_FURFROU_MATRON[]     = _("Matron");
