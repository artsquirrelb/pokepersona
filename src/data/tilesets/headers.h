...
const struct Tileset gTileset_Gen4General =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Gen4General,
...
const struct Tileset gTileset_Gen4Building =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Gen4Building,
    .palettes = gTilesetPalettes_Gen4Building,
    .metatiles = gMetatiles_Gen4Building,
    .metatileAttributes = gMetatileAttributes_Gen4Building,
    .callback = NULL,
};

const struct Tileset gTileset_SunshineTown =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SunshineTown,
    .palettes = gTilesetPalettes_SunshineTown,
    .metatiles = gMetatiles_SunshineTown,
...
const struct Tileset gTileset_SunshineOrphanageEntrance =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SunshineOrphanageEntrance,
...
const struct Tileset gTileset_HiddenGrotto =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_HiddenGrotto,
    .palettes = gTilesetPalettes_HiddenGrotto,
    .metatiles = gMetatiles_HiddenGrotto,
...
const struct Tileset gTileset_MansionTrainingHouse =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_MansionTrainingHouse,
    .palettes = gTilesetPalettes_MansionTrainingHouse,
    .metatiles = gMetatiles_MansionTrainingHouse,
    .metatileAttributes = gMetatileAttributes_MansionTrainingHouse,
    .callback = NULL,
};

const struct Tileset gTileset_Dungeon =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Dungeon,
    .palettes = gTilesetPalettes_Dungeon,
    .metatiles = gMetatiles_Dungeon,
    .metatileAttributes = gMetatileAttributes_Dungeon,
    .callback = NULL,
};

const struct Tileset gTileset_StoneCave =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_StoneCave,
    .palettes = gTilesetPalettes_StoneCave,
    .metatiles = gMetatiles_StoneCave,
