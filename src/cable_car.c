...
static void CreateCableCarSprites(void)
{
    ...
    u16 playerGraphicsId = GetPlayerAvatarGraphicsIdByOutfitStateIdAndGender(gSaveBlock2Ptr->currOutfitId, PLAYER_AVATAR_STATE_NORMAL, gSaveBlock2Ptr->playerGender);
    u16 rval = Random();
